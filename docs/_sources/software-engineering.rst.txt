...
Large-scale applications are built on these three pillars. Lack of any one of them is acceptable during research, but reproducibility, proof of correctness, and ease of experimentation are critical for large-scale applications.
